//! Public-URL receipt hosting for BoardProof.
//!
//! Master plan §21 #1 + §28 Phase 2. Turns `boardproof://receipt/<hash>`
...
//! `boardproof-verify` or any Ed25519-aware tool).
//!
//! ## Endpoints (v0)
//!
//! | Method | Path                 | Returns                                                   |
...
use boardproof_receipt::{Digest, HexDecodeError};
use boardproof_store::ReceiptLog;
...
async fn get_index() -> impl IntoResponse {
    const BODY: &str = concat!(
        ...
        "<title>BoardProof — verifiable receipt host</title></head>",
        ...
        "produced by a BoardProof kernel. Each receipt is verifiable cold ",
        ...
        "</ul>",
        "<p>See <a href=\"https://github.com/UniClaw-Lab/boardproof\">the project on GitHub</a> ",
...
mod tests {
    ...
    async fn verify_page_contains_essential_ui_and_crypto_subtle_call() {
        ...
        assert!(body.contains("BoardProof Receipt Verifier"));
