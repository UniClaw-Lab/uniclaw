...
use boardproof_budget::{BudgetError, CapabilityLease};
use boardproof_receipt::{Digest, Receipt};
...
pub struct KernelOutcome {
    ...
    /// machine-readable trail used by `boardproof explain` and similar tools.
