//! Integration tests for [`boardproof_tools_wasm::WasmTool::from_component_bytes_with_host`]
...
// =====================================================================
// Mock HTTP server — same shape as boardproof-tools-http's integration
...
fn host_imports_invalid_bytes_fail_at_construction() {
    ...
    assert!(matches!(
        err,
        boardproof_tools_wasm::BuildError::InvalidWasm(_)
    ));
}
