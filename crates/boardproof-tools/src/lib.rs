//! Tool execution architecture for BoardProof.
//!
...
//!
//! - **No WASM runtime.** That lives in `boardproof-tools-wasm` (next
...
//!   spirit. BoardProof's enum is leaner (7 variants, no MemoryRead/Write
