...
use boardproof_constitution::{Constitution, parse_toml};
use boardproof_receipt::{Action, Decision, Digest};

fn load_solo_dev() -> impl Constitution {
    // The crate lives at crates/boardproof-constitution; the constitution file
