...
/// - `user_agent`: `boardproof-tools-http/<crate-version>`
...
pub struct HttpFetchConfig {
    ...
    /// returning [`boardproof_tools::ToolError::Failed`].
...
impl Default for HttpFetchConfig {
    fn default() -> Self {
        Self {
            ...
            user_agent: format!("boardproof-tools-http/{}", env!("CARGO_PKG_VERSION")),
...
mod tests {
    ...
    fn default_config_is_safe() {
        ...
        assert!(c.user_agent.starts_with("boardproof-tools-http/"));
    }
