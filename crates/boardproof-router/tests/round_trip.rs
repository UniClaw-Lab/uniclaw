...
use boardproof_kernel::{Clock, Kernel, OutcomeKind, Proposal, Signer};
use boardproof_receipt::{Action, Decision, Digest, Receipt, ReceiptBody, crypto};
use boardproof_router::{ApprovalRouter, CliApprovalRouter, RouterError, evaluate_with_routing};
...
fn fresh_kernel<C: boardproof_constitution::Constitution>(
    constitution: C,
