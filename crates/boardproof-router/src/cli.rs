...
use boardproof_explain::{explain, render_text};
use boardproof_kernel::Proposal;
...
mod tests {
    ...
    fn dummy_pending() -> Receipt {
        Receipt {
            ...
            issuer: boardproof_receipt::PublicKey([0xCC; 32]),
            signature: boardproof_receipt::Signature([0xDD; 64]),
        }
    }
